    ...
    function T(t, f, o) {
            ...
            k(),
                ...
                I("update" + St.tooltips, function (t, e, r) {
                    a &&
                        f.tooltips &&
                        !1 !== a[e] &&
                        ((t = t[e]), !0 !== f.tooltips[e] && (t = f.tooltips[e].to(r[e])), (a[e].innerHTML = t));
                });
        }
        function U(t, e) {
        ...
        function z(n, i, o, s) {
            function e(t) {
                ...
                return (
                    ...
                    (t = f.cssClasses.tap),
                    !(
                        (e.classList ? e.classList.contains(t) : new RegExp("\\b" + t + "\\b").test(e.className)) &&
                        !s.doNotReject
                    ) &&
        ...
        function _(t, e) {
            e.handle && (vt(e.handle, f.cssClasses.active), --v),
                ...
                0 === v &&
                    ...
                    tt(),
                    t.cursor && ((E.style.cursor = ""), E.removeEventListener("selectstart", ft))),
        ...
        function B(t, e) {
            ...
            e.handleNumbers.some(A) ||
                (1 === e.handleNumbers.length &&
                    ((o = l[e.handleNumbers[0]].children[0]), (v += 1), gt(o, f.cssClasses.active)),
                t.stopPropagation(),
                (n = z(c.move, w, R, {
                    target: t.target,
                    handle: o,
        ...
        function q(t) {
            ...
            !1 !== r &&
                ...
                $("slide", r, !0),
                $("update", r, !0),
                f.events.snap ? B(t, { handleNumbers: [r] }) : ($("change", r, !0), $("set", r, !0)));
        }
        function X(t) {
            var t = H(t.calcPoint),
                t = S.getStep(t),
        ...
        function W(t) {
            ...
            Object.keys(b).forEach(function (t) {
                ...
                (n && n !== e) ||
                    (i && i !== r) ||
                    ((((e = r) !== St.aria && e !== St.tooltips) || i === r) && delete b[t]);
            });
        }
        function $(r, n, i) {
            Object.keys(b).forEach(function (t) {
        ...
        function rt(t) {
            ...
            u[t] &&
                ...
                (r =
                    "translate(" +
                    J(Q((r = (r = 0) !== t ? e[t - 1] : r), (n = (n = t !== u.length - 1 ? e[t] : n) - r)) + "%", "0") +
                    ")"),
                (n = "scale(" + J(n / 100, "1") + ")"),
        ...
        gt((t = d), f.cssClasses.target),
            ...
            gt(
                t,
                "rtl" === getComputedStyle(t).direction ? f.cssClasses.textDirectionRtl : f.cssClasses.textDirectionLtr
            ),
